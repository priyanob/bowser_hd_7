...
# Graphics
PRODUCT_COPY_FILES += \
    $(DEVICE_FOLDER)/prebuilt/sgx/gralloc.omap4460.so:/system/vendor/lib/hw/gralloc.omap4.so \
    ...
    $(DEVICE_FOLDER)/prebuilt/lib/libbltsville_cpu.so:/system/vendor/lib/ \
    $(DEVICE_FOLDER)/prebuilt/lib/libbltsville_ticpu.2.0.0.8.so:/system/vendor/lib/libbltsville_ticpu.2.0.0.8.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libbltsville_ticpu.so:/system/vendor/lib/libbltsville_ticpu.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libbltsville_ticpu_license.txt:/system/vendor/lib/libbltsville_ticpu_license.txt \
    $(DEVICE_FOLDER)/prebuilt/lib/libglslcompiler.so:/system/vendor/lib/libglslcompiler.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libIMGegl.so:/system/vendor/lib/libIMGegl.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libpvr2d.so:/system/vendor/lib/libpvr2d.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libpvrANDROID_WSEGL.so:/system/vendor/lib/libpvrANDROID_WSEGL.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libPVRScopeServices.so:/system/vendor/lib/libPVRScopeServices.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libsmapi.so:/system/vendor/lib/libsmapi.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libsrv_init.so:/system/vendor/lib/libsrv_init.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libsrv_um.so:/system/vendor/lib/libsrv_um.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libtf_crypto_sst.so:/system/vendor/lib/libtf_crypto_sst.so \
    $(DEVICE_FOLDER)/prebuilt/lib/libusc.so:/system/vendor/lib/libusc.so
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_FOLDER)/prebuilt/bin/pvrsrvctl:/system/bin/pvrsrvctl \
    $(DEVICE_FOLDER)/prebuilt/bin/pvrsrvinit:/system/bin/pvrsrvinit \
...
PRODUCT_COPY_FILES += \
	...
	$(DEVICE_FOLDER)/prebuilt/lib/camera.omap4.so:/system/vendor/lib/hw/camera.omap4.so \
...
PRODUCT_COPY_FILES += \
	...
	$(DEVICE_FOLDER)/firmware/wifi/nvram_tate_semco.txt:system/etc/wifi/nvram_tate_semco.txt \
...
RODUCT_VENDOR_KERNEL_HEADERS := hardware/ti/omap4xxx/kernel-headers
RODUCT_PACKAGES += \
	libdomx \
	libOMX_Core \
